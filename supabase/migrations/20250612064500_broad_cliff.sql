/*
  ...
  2. Security
    ...
    - Add policy for authenticated users to manage their own things to note
...
CREATE TABLE IF NOT EXISTS things_to_note (
  ...
  CONSTRAINT fk_things_to_note_property_id 
...
CREATE INDEX IF NOT EXISTS idx_things_to_note_property_id 
  ON things_to_note(property_id);